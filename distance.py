...
# from reward import decode_fen, expand_fen, min_fen_distance
...
# class DistanceLimitedRewardManager(RewardManagerBase):
#     _semaphore = None
...
#                 fen = expand_fen(decode_fen(response_str, "v0-verbose"))

#                 if self._expanded_fens:
#                     min_dist = min_fen_distance(fen, self._expanded_fens)
#                     reward_extra_info["min_fen_distance"] = min_dist
#                     if min_dist < fen_distance_threshold:
#                         reward = 0
#                         reward_extra_info['score'] = 0
#                 else:
#                     reward_extra_info["min_fen_distance"] = 1000

#                 if score == 1:
#                     self._expanded_fens.append(fen)
